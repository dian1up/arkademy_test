            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list mg-t-30">
                        ...
                        <div class="row">
                          <input type="submit" value="Submit" class="bbtn btn-success notika-btn-success">
                          </form>

                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                              <a href="index.php"> <button  type="button" class="bbtn btn-success notika-btn-success" >CANCEL</button></a>
                            </div>
